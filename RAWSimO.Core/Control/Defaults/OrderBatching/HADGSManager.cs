...
namespace RAWSimO.Core.Control.Defaults.OrderBatching
{
    ...
    public class HADGSManager : OrderManager
    {
        ...
        private void Initialize()
        {
            ...
            normalScorers.Add(() =>
            {
                HashSet<ExtractRequest> itemDemands = Instance.ResourceManager.GetExtractRequestsOfOrder(_currentOrder).ToHashSet();
                    ...
                    .Where(s => validStationNormalAssignment(s)))
                {
                    ...
                    while (validStationNormalAssignment(station) && furtherOptions1)
                    {
                        ...
                        if (chosenOrder != null)
                        {
                            ...
                            HashSet<ExtractRequest> itemDemands = Instance.ResourceManager.GetExtractRequestsOfOrder(chosenOrder).ToHashSet();
                            //int i = 0;
                            // Get current content of the pod
